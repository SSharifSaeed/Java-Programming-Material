...
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
// IF I AM NOT ON THE ROSTER, I ACCIDENTALLY DROPPED THE CLASS 1/26. I AM ATTEMPTING TO REJOIN
// AS SOON AS POSSIBLE. PLEASE CONSIDER THIS WHILE GRADING. THANK YOU. 
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
	public class NumberCruncher {
			...
			*
			*
			* This method returns true if they are coprime, and false otherwise
			*
			*
			*/
			...
			/**
			*
			* This method returns true if in fibonacci sequence and is prime number
			*
			*
			*/
